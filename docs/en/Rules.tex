...
In any case, bullet dissapears immediatly, dealing damage if hit a unit.
...
Reloading a weapon happens automatically. First, when the weapon is just picked up.
...
After been triggerd, some time will pass and then the mine will explode, deaing damage to all units in specified explosion radius.
