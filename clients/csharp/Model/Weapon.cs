namespace AiCup2019.Model
{
    ...
    {
        public Model.WeaponType Type { get; set; }
        ...
        public Weapon(Model.WeaponType type, Model.WeaponParameters parameters, int magazine, bool wasShooting, double spread, double? fireTimer, double? lastAngle, int? lastFireTick)
        {
            this.Type = type;
        ...
        public static Weapon ReadFrom(System.IO.BinaryReader reader)
        {
            ...
            {
            case 0:
                result.Type = Model.WeaponType.Pistol;
                break;
            case 1:
                result.Type = Model.WeaponType.AssaultRifle;
                break;
            case 2:
                result.Type = Model.WeaponType.RocketLauncher;
                break;
            default:
